...
echo "====================================================="
echo "1. Retrieving Cloud Run Service URL..."
echo "====================================================="
...
# Register the authorization resource (we can ignore the 409 harmlessly)
curl -s -X POST \
...
echo "Authorization registered (or already existed). Output suppressed for clarity."
